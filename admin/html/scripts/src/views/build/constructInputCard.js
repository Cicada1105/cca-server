...
function constructGenericInputCardData(controlMethods, event) {
	let { applyListenersFunc, displayData } = this;
...
function constructGenericServiceInputCardData({ inputCardID, submitMethod, clearMethod }, event) {
	let { applyListenersFunc = "", ...rest } = this;
...
export { constructGenericInputCardData, constructGenericServiceInputCardData }